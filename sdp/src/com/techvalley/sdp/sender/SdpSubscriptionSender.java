...
public class SdpSubscriptionSender {
	
	
	public void subscribeSender(String spId, String password, String timeStamp, String msisdn, String productId, Boolean isAutoExtend, String channelId){
	...
	private String subscribeXML(String spId, String password, String timeStamp, String msisdn, String productId, Boolean isAutoExtend, String channelId)
    {
